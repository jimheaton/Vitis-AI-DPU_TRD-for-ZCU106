...
################################################################
# This is a generated script based on design: zcu106_dpu
#
...
if { $list_projs eq "" } {
   create_project zcu106_dpu zcu106_dpu -part xczu7ev-ffvc1156-2-e
...
set_property SELECTED_SIM_MODEL tlm [get_bd_cells /ps_e]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins interconnect_axifull/M00_AXI] [get_bd_intf_pins ps_e/S_AXI_HPC0_FPD]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins axi_register_slice_0/aclk] [get_bd_pins axi_vip_0/aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins interconnect_axifull/ACLK] [get_bd_pins interconnect_axifull/M00_ACLK] [get_bd_pins interconnect_axifull/S00_ACLK] [get_bd_pins interconnect_axihpm0fpd/ACLK] [get_bd_pins interconnect_axihpm0fpd/M00_ACLK] [get_bd_pins interconnect_axihpm0fpd/S00_ACLK] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps_e/maxihpm0_fpd_aclk] [get_bd_pins ps_e/saxihpc0_fpd_aclk]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_vip_0/Master_AXI] [get_bd_addr_segs ps_e/SAXIGP0/HPC0_DDR_LOW] -force
  ...
  set_property PFM_NAME {xilinx:zcu106:zcu106_dpu:1.0} [get_files [current_bd_design].bd]
  ...
  set_property PFM.AXI_PORT {M_AXI_HPM1_FPD {memport "M_AXI_GP"}  S_AXI_HPC1_FPD {memport "S_AXI_HPC" sptag "HPC1" memory "ps_e HPC1_DDR_LOW"}  S_AXI_HP0_FPD {memport "S_AXI_HP" sptag "HP0" memory "ps_e HP0_DDR_LOW"}  S_AXI_HP1_FPD {memport "S_AXI_HP" sptag "HP1" memory "ps_e HP1_DDR_LOW"}  S_AXI_HP2_FPD {memport "S_AXI_HP" sptag "HP2" memory "ps_e HP2_DDR_LOW"}  S_AXI_HP3_FPD {memport "S_AXI_HP" sptag "HP3" memory "ps_e HP3_DDR_LOW"}} [get_bd_cells /ps_e]
...
for {set i 1} {$i < 16} {incr i} {
  lappend hpc0Val S[format %02d $i]_AXI {memport "S_AXI_HP" sptag "HPC0" memory "ps_e HPC0_DDR_LOW"}
}
...
generate_target  all  [get_files  ./zcu106_dpu/zcu106_dpu.srcs/sources_1/bd/zcu106_dpu/zcu106_dpu.bd]
set_property generate_synth_checkpoint true [get_files -norecurse *.bd]
make_wrapper -files [get_files ./zcu106_dpu/zcu106_dpu.srcs/sources_1/bd/zcu106_dpu/zcu106_dpu.bd] -top
add_files -norecurse ./zcu106_dpu/zcu106_dpu.srcs/sources_1/bd/zcu106_dpu/hdl/zcu106_dpu_wrapper.v
...
file mkdir ./zcu106_dpu/zcu106_dpu.sdk
write_hwdef -force  -file ./zcu106_dpu/zcu106_dpu.sdk/zcu106_dpu_wrapper.hdf

set_property platform.post_sys_link_tcl_hook ./dynamic_postlink.tcl [current_project]

write_hw_platform -unified -include_bit ./zcu106_dpu.xsa
#write_hw_platform -force  ./zcu106_dpu.xsa

validate_hw_platform ./zcu106_dpu.xsa
